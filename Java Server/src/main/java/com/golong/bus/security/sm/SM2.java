package com.golong.bus.security.sm;
...
public class SM2 {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		ECPoint publicKey0 = keyPair.getPublicKey();
		BigInteger privateKey0 = keyPair.getPrivateKey();
		String path = "/Users/luofly/downloads/";
		sm02.exportPublicKey(publicKey0, path + "publickey.pem");
		sm02.exportPrivateKey(privateKey0, path + "privatekey.pem");

		System.out.println("-----------------公钥加密与解密-----------------");
		ECPoint publicKey = sm02.importPublicKey(path + "publickey.pem");
		BigInteger privateKey = sm02.importPrivateKey(path + "privatekey.pem");
